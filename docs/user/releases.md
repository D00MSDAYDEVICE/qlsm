...
| --- | --- | --- | --- |
| `v1.40.5` | 2026-09-18 | [#227](https://github.com/dngrtech/qlsm/pull/227) | The **Owner & Admins** tab scrollbar now matches the dark theme and lines up with the other tabs. |
