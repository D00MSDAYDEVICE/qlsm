...
| --- | --- | --- | --- |
| `v1.36.1` | 2026-09-16 | [#215](https://github.com/dngrtech/qlsm/pull/215) | Fix downloading a plugin that already exists showing a "502 Bad gateway" error behind Cloudflare instead of the overwrite prompt. |
